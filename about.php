						...
						<ul class="nav-menu nav navbar-nav">
							...
							if ($result->num_rows > 0) {
								while ($row = $result->fetch_assoc()) {
									?>
									<li class="cat-1"><a href="category.php"><?php echo $row['name'] ?></a></li>
									<?php
								}
							}
							?>
						...
						if ($result->num_rows > 0) {
							while ($row = $result->fetch_assoc()) {
								...
								<div class="post post-widget">
									<a class="post-img" href="blog-post.php?id=<?php echo $row['id'] ?>"><img src="<?php echo$row['thumbnail'] ?>" alt=""></a>
									<div class="post-body">
										<h3 class="post-title"><a href="blog-post.php?id=<?php echo $row['id'] ?>"><?php echo$row['tieude'] ?></a></h3>
									</div>
								</div>
								<?php
							}
									...
									<div class="footer-widget">
										...
										<ul class="footer-links">
											...
											if ($result->num_rows > 0) {
												while ($row = $result->fetch_assoc()) {
													?>
													<li><a href="category.php"><?php echo $row['name'] ?></a></li>
													<?php
												}
											}
											?>
