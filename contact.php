			...
			<div id="nav">
				...
				<div id="nav-fixed">
					<div class="container">
						<!-- logo -->
						<div class="nav-logo">
							<a href="index.phpphpphp" class="logo"><img src="./img/logo.png" alt=""></a>
						</div>
						<!-- /logo -->

						<!-- nav -->
						<ul class="nav-menu nav navbar-nav">
							<li><a href="category.phpphp">News</a></li>
							<li><a href="category.phpphp">Popular</a></li>
							<li class="cat-1"><a href="category.phpphp">Web Design</a></li>
							<li class="cat-2"><a href="category.phpphp">JavaScript</a></li>
							<li class="cat-3"><a href="category.phpphp">Css</a></li>
							<li class="cat-4"><a href="category.phpphp">Jquery</a></li>
						</ul>
						<!-- /nav -->
